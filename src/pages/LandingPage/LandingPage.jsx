  ...
  return (
    <div className='w-screen h-screen'>
        ...
        <div className='w-full flex justify-center items-center mt-28'>
          <div className=' w-9/12 h-full p-5 md:backdrop-blur-md rounded-md bg-white/10'>
            ...
            <div className='flex p-5 justify-evenly'>
              <section className='rounded-md bg-white/10 p-5 w-1/2 flex items-center'>
        ...
        <footer className='h-12 bg-white/10 absolute bottom-0 flex items-center p-2 px-5 w-full'>
